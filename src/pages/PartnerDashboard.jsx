...
const PartnerDashboard = () => {
  ...
  // Wrap fetchUserApplications with useCallback
  ...
  // Update useEffect to include fetchUserApplications
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Resources Section - Fixed anchor tags */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-primary mb-4">Partner Resources</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              onClick={() => alert('Partner Guide coming soon!')}
              className="w-full p-4 bg-gray-50 rounded-lg hover:bg-accent/5 transition group text-left"
            >
